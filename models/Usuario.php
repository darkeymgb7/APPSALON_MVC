...
class Usuario extends ActiveRecord{
    ...
    public function validarNuevaCuenta(){
        ...
        if(strlen($this->password)<6){
            self::$alertas['error'][] ='La contraseña debe contener
    ...
    public function validarPassword(){
        ...
        if(strlen($this->password) <6){
            self::$alertas['error'] [] = 'La constraseña debe contener al menos 6 caracteres';
        }
        return self::$alertas;
    }
    ...
    public function comprobarPasswordAndVerificado($password){
        ...
        if (!$resultado || !$this->confirmado) {
            self::$alertas['error'] []= 'Constraseña incorrecta o tu cuenta no ha sido confirmada';
